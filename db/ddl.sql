create table payment.payment_user
(
...
alter table payment.payment_user
    owner to postgres;

create table payment.payment_user_card
(
    id                 integer generated always as identity
...
alter table payment.payment_user_card
    owner to postgres;

create table payment.payment_user_point
(
    id                integer generated always as identity
...
alter table payment.payment_user_point
    owner to postgres;
...
create table payment.payment_detail
(
    id                         integer generated always as identity
...
create table payment.payment_user_point_history
(
    id                 integer generated always as identity
...
alter table payment.payment_user_point_history
    owner to postgres;
